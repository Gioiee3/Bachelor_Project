...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|PWR_SEN_Pin|GPIO_PIN_14|LoRa_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DE_Pin|SPI1_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PB0 PBPin PB14 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|PWR_SEN_Pin|GPIO_PIN_14;
